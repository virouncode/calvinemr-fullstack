...
import FSHHistoryEdit from "./History/FSHHistoryEdit";

type CareElementsFSHProps = {
...
const CareElementsFSH = ({
  datas,
  lastDatas,
  careElementPut,
  handleClickHistory,
}: CareElementsFSHProps) => {
  //Hooks
      ...
      {lastDatas.FSH?.FSH && (
        <div className="care-elements__card-content-row-btns">
          <Tooltip title="Show history">
            <span>
              <ClockIcon onClick={() => handleClickHistory("FSH")} mr={15} />
            </span>
          </Tooltip>
...
export default CareElementsFSH;
