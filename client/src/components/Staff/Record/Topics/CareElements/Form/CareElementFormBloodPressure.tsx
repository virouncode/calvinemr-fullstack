...
type CareElementFormBloodPressureProps = {
...
const CareElementFormBloodPressure = ({
  setAddVisible,
  careElementToAdd,
  careElementsDatas,
  patientId,
  topicPost,
  topicPut,
}: CareElementFormBloodPressureProps) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formDatas.DiastolicBP || !regex.test(formDatas.DiastolicBP)) {
    ...
    if (careElementsDatas) {
      const topicToPut: CareElementType = {
        ...
        BloodPressure: [...careElementsDatas.BloodPressure, formDatas],
      };
      setProgress(true);
...
export default CareElementFormBloodPressure;
