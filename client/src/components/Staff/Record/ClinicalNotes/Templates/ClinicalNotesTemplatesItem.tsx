...
type ClinicalNotesTemplatesItemProps = {
...
const ClinicalNotesTemplatesItem = ({
  ...
  const handleDuplicate = async (template: ClinicalNoteTemplateType) => {
  ...
  const handleLike = async (template: ClinicalNoteTemplateType) => {
