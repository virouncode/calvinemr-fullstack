...
import AgeCalculatorPU from "../Topics/AgeCalculator/AgeCalculatorPU";
...
import GroupsContent from "../Topics/Groups/GroupsContent";
  ...
  return (
    <div className="patient-record__topic">
      ...
      >
        ...
        {/* AGE CALCULATOR */}
        {topic === "AGE CALCULATOR" && popUpVisible && (
          <FakeWindow
            ...
            setPopUpVisible={setPopUpVisible}
          >
            <AgeCalculatorPU patientDob={demographicsInfos.DateOfBirth} />
          </FakeWindow>
        )}
        {/*******************/}
        {/* LABELS */}
